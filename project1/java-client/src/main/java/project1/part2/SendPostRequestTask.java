...
public class SendPostRequestTask implements Runnable {
    ...
    //     RequestResult result = sendRequestsUntilSuccessful(event);
    //     if (result != null) {
    ...
    //         return new RequestResult(response.getStatusCode(), latency);
    //     } catch (ApiException e) {
    //         long latency = System.currentTimeMillis() - startTime;
    //         handleApiException(e);
    //         return new RequestResult(e.getCode(), latency);
    //     }
    // }
